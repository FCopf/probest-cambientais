...
Para que os somatórios dos quadrados expressem uma medida de variação é necessáro corrigir para o tamanhos amostrais apropriados. Fazemos isto obtendo os **Quadrados médios**. Estas quantias são dadas por:
